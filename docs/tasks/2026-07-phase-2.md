...
> Archived 2026-07-07. All tasks completed on branch `feature/phase-2`
> (docs reorg, real PNG app icon, parallel per-frame normal-mode
> extraction ~220×, cold-start Finder-open race fix).
